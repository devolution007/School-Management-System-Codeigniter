...
class Question extends Admin_Controller
{
    ...
    public function getDatatable()
    {
        ...
        $question_dt = $this->question_model->getAllRecord($class_id, $section_id, $subject, $search_question_type, $search_question_level, $created_by, $created_at);
        ...
        if (!empty($question_dt->data)) {
            foreach ($question_dt->data as $key => $value) {
                ...
                $row[] = date('d-m-Y', strtotime($value->created_at)); // print the date
