...
class Student extends Admin_Controller
{
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($insert) {
                ...
                $data_student_login = array(
                    'username' => $this->input->post('firstname') . $insert_id,
                ...
                $upload_dir_path = './uploads/student_documents/' . $insert_id . '/';
    ...
    public function create_doc()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if (isset($_FILES["first_doc"]) && !empty($_FILES['first_doc']['name'])) {
                $upload_dir_path = base_url() . './uploads/student_documents/' . $student_id . '/';
    ...
    {
        $student_login_detail = array('id' => $this->input->post('student_id'), 'credential_for' => 'student', 'username' => $this->input->post('username'), 'password' => $this->input->post('password'), 'contact_no' => $this->input->post('contact_no'), 'email' => $this->input->post('email'), 'admission_no' => $this->input->post('admission_no'));
    ...
    {
        $parent_login_detail = array('id' => $this->input->post('student_id'), 'credential_for' => 'parent', 'username' => $this->input->post('username'), 'password' => $this->input->post('password'), 'contact_no' => $this->input->post('contact_no'), 'email' => $this->input->post('email'), 'admission_no' => $this->input->post('admission_no'));
