...
class Setting_model extends MY_Model {
    ...
    public function get_assisments(){
        $this->db->select('assessments_detail,assessments_marks');
        return $this->db->where('id',1)->get('sch_settings')->row();
    }
