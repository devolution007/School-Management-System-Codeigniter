...
class Question_model extends MY_model
{
    ...
    public function getAllRecord($class_id,$section_id,$subject,$question_type,$question_level,$created_by,$created_at)
    {
        ...
        if (!empty($created_at)) {
            $this->datatables->where('questions.created_at >=', $created_at['start_date']);
            $this->datatables->where('questions.created_at <=', $created_at['end_date']);
        }
        ...
        $this->datatables->select('questions.*,subjects.name,subjects.code,classes.class as class_name,sections.section as section_name,staff.name as staff_name,staff.surname as staff_surname,staff.employee_id,staff_roles.role_id as created_role, questions.created_at'); // include created_at column
