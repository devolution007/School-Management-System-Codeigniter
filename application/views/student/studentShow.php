...
if (!empty($student["image"])) {
             ...
             $image_url=base_url($student["image"]);
                            ...
                            <li class="list-group-item listnoback">
                                ...
                                <?php if (file_exists("./uploads/student_id_card/barcodes/" . $student['admission_no'] . ".png")) {?>
                                   <a class="pull-right text-aqua">
                                    <img class="h-36" src="<?php echo base_url('uploads/student_id_card/barcodes/' . $student['admission_no'] . '.png'); ?>" width="auto" height="auto"/></a>
                                <?php }?>
                            </li>
                            <?php }?>
                                    ...
                                    <div class="no-padding">
                                        <ul class="list-group list-group-unbordered">
                                            ...
                                            <li class="list-group-item listnoback">
                                                ...
                                                <a class="pull-right text-aqua">
                                                    <img class="h-36" src="<?php echo base_url('uploads/student_id_card/barcodes/' . $sibling_value->admission_no ); ?>" width="auto" height="auto"/></a>
                                                <?php }?>
                                            </li>
                                            <?php }?>
                                        </ul>
