            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <form role="form" id="form" action="<?=base_url('user/user/searchvalidation')?>"
                                method="post" class="class_search_form">
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <select autofocus="" id="session" name="session" class="form-control">
                                                    ...
                                                    <option value="<?php echo $session['id'] ?>" <?php 
                                                                 if (set_value('session') == $session['id']) {
...
?>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <button type="button" name="search" id="search" value="search_filter"
                    ...
                    <div class="nav-tabs-custom border0 navnoshadow">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab_1" data-toggle="tab" aria-expanded="true"><i
                                        class="fa fa-list"></i> <?php echo $this->lang->line('list_view'); ?></a></li>
                            <li class=""><a href="#tab_2" data-toggle="tab" aria-expanded="false"><i
                                        class="fa fa-newspaper-o"></i>
                                    <?php echo $this->lang->line('details_view'); ?></a></li>
                        </ul>
                        <div class="tab-content">
                            <div class="tab-pane active table-responsive no-padding overflow-visible" id="tab_1">
                                <table class="table table-striped table-bordered table-hover student-list"
                                    data-export-title="<?php echo $this->lang->line('student_list'); ?>">
                                    <thead>
                                        <tr>
                                ...
                                <div class="carousel-row">
                                    <div class="slide-row">
                                            ...
                                            <div class="carousel-inner">
                                                <div class="item active">
                                                    <a
                                                        ...
                                                        <?php if ($sch_setting->student_photo) {?><img
                                                            class="img-responsive img-thumbnail width150"
                                                            alt="<?php echo $student["firstname"] . " " . $student["lastname"] ?>"
                                                            src="<?php echo $this->media_storage->getImageURL($image); ?>"
                                                            alt="Image"><?php }?></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="slide-content">
                                            <h4><a
                                                    href="<?php echo base_url(); ?>student/view/<?php echo $student['id'] ?>">
                                                    <?php echo $this->customlib->getFullName($student['firstname'], $student['middlename'], $student['lastname'], $sch_setting->middlename, $sch_setting->lastname); ?></a>
                                            </h4>
                                            <div class="row">
                                                ...
                                                <div class="col-xs-6 col-md-6">
                                                    ...
                                                    <?php echo $student['guardian_phone'] ?><br> <?php }?>
...
$(document).ready(function() {
    ...
    $(document).on('click', '#search', function(e) {
        ...
        var $this = $("button[type=button][clicked=true]");
      
        // Assuming the button is inside the form you wish to serialize
        var form = $(this).closest('form');

        // Ensure the form variable is correctly pointing to a form element
        if (form.length === 0) {
            console.error('Form not found!');
            return; // Exit the function if no form is found
        }

        var url = '<?=base_url('user/user/searchvalidation')?>'; // Your endpoint
        var form_data = form.serialize(); // Use serialize() if you're making a POST request
            ...
            success: function(response) { // your success handler
                ...
                if (!response.status) {
                    ...
                    if ($.fn.DataTable.isDataTable(
                            '.student-list')) { // if exist datatable it will destrory first
                    ...
                    table = $('.student-list').DataTable({
                        ...
                        "serverSide": true,
                        "ajax": {
                            "url": "<?=base_url('user/user/dtstudentlist')?>",
                            "dataSrc": 'data',
                            "type": "POST",
                        ...
                        "drawCallback": function(settings) {
                            ...
                            $('.detail_view_tab').html("").html(settings.json
                                .student_detail_view);
                        }
