    ...
    <div class="box border0">
        <ul class="tablists">
            ...
            <li class="<?php echo set_SubSubmenu('schsettings/attendancetype'); ?>">
                <a class="<?php echo set_SubSubmenu('schsettings/attendancetype'); ?>" href="<?php echo site_url('schsettings/exam_settings') ?>">Exams & Report Card Settings</a>
            </li>
            <li class="<?php echo set_SubSubmenu('schsettings/attendancetype'); ?>">
            ...
            <li class="<?php echo set_SubSubmenu('schsettings/grade_setting'); ?>">
                <a class="<?php echo set_SubSubmenu('schsettings/grade_setting'); ?>" href="<?php echo site_url('schsettings/grade_setting') ?>"><?php echo $this->lang->line('grade_setting'); ?></a>
            </li>
            <li class="<?php echo set_SubSubmenu('schsettings/permotion_setting'); ?>">
                
                
                <a class="<?php echo set_SubSubmenu('schsettings/permotion_setting'); ?>" href="<?php echo site_url('schsettings/permotion_setting') ?>"><?php echo $this->lang->line('permotion_setting'); ?>Promotion Setting</a>
