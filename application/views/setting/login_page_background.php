                                ...
                                <h4><?php echo $this->lang->line('admin_penal'); ?></h4> 
                                    <div class="text-center">    
                                        <div class="card-h-hidden">
                                            ...
                                            if ($result->image == "") {
                                                ?>
                                                <div class="card-body-logo-img"><img src="<?php echo base_url('uploads/school_content/login_image/images.png'); ?>" class="" alt="" width="304" height="236"></div>
                                                <?php
                                            } else {
                                                ?>
                                                <div class="card-body-logo-img"><img src="<?php echo base_url('uploads/school_content/login_image/'. $result->admin_login_page_background); ?>" class="" alt="" width="304" height="236"></div>
                                                <?php
                                            }
                                            ?>
                                        </div>    
                                    ...
                                    <div class="text-center">     
                                        <div class="card-h-hidden">
                                            ...
                                            if ($result->image == "") {
                                                ...
                                                ?>
                                                <div class="card-body-logo-img"><img src="<?php echo base_url('uploads/school_content/login_image/'. $result->user_login_page_background); ?>" class="" alt="" width="304" height="236"></div>
                                                <?php
                                            }
                                            ?>
                                        </div>    
