                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                ...
                                <h4> <?php echo $this->lang->line('print_logo'); ?></h4> 
                                    <div class="text-center">     
                                        ...
                                        if ($result->image == "") {
                                            ?>
                                            <div class="card-body-logo-img"><img src="<?php echo base_url('uploads/school_content/logo/images.png') ?>" class="" alt="" width="304" height="236"></div>
                                            <?php
                                        } else {
                                            ?>
                                            <div class="card-body-logo-img"><img src="<?php echo base_url('uploads/school_content/logo/'.$result->image); ?>" class="" alt="" width="304" height="236"></div>
                                            <?php
                                        }
                                        ?>
                                        <p class="bolds ptt10">(200px X 200px)</p>
                                    </div>    
                                ...
                                <div class="card-body-logo">
                                    ...
                                    <div class="text-center"> 
                                        ...
                                        if ($result->admin_logo == "") {
                                            ?>
                                            <div class="card-body-logo-img"><img src="<?php echo base_url('uploads/school_content/admin_logo/images.png'); ?>" class="" alt="" width="204" height="60"></div>
                                            <?php
                                        } else {
                                            ?>
                                            <div class="card-body-logo-img"><img src="<?php echo base_url('uploads/school_content/admin_logo/'.$result->admin_logo); ?>" class="" alt="" width="204" height="60"></div>
                                            <?php
                                        }
                                        ?>
                                ...
                                <h4><?php echo $this->lang->line('admin_small_logo'); ?></h4>   
                                    <div class="text-center"> 
                                        ...
                                        if ($result->admin_small_logo == "") {
                                            ?>
                                            <img src="<?php echo base_url('uploads/school_content/logo/images.png'); ?>" alt="">
                                            <?php
                                        } else {
                                            ?>
                                            <img src="<?php echo base_url('uploads/school_content/admin_small_logo/'.$result->admin_small_logo); ?>" width="32" height="32">
                                            <?php
                                        }
                                        ?>
                                        
                                        <p class="bolds ptt10">(60px X 60px)</p>
                                    </div>    
                             ...
                             <div class="col-lg-3 col-md-6 col-sm-6">
                                ...
                                <h4><?php echo $this->lang->line('app_logo'); ?> </h4> 
                                    <div class="text-center">    
                                        ...
                                        if ($result->app_logo == "") {
                                            ?>
                                            <div class="card-body-logo-img"><img src="<?php echo base_url('uploads/school_content/logo/images.png'); ?>" class="" alt="" width="290" height="51"></div>
                                            <?php
                                        } else {
                                            ?>
                                            <div class="card-body-logo-img"><img src="<?php echo base_url('uploads/school_content/logo/app_logo/'.$result->app_logo); ?>" width="290" height="51"></div>
                                            <?php
                                        }
                                        ?>
