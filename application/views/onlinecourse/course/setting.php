                        ...
                        <form action="<?=site_url();?>onlinecourse/course/setting" method="post" class="form-horizontal form-label-left">
                            ...
                            <div class="box-footer">
                                <div class="col-md-6 col-sm-6 col-xs-6 col-md-offset-3">                              
                                    <button type="submit" name="setting_btn" value="aws" class="btn btn-info pull-left"><?php echo $this->lang->line('save'); ?></button>                                                         
                                </div>                                 
                            </div>
                        </form>
                    </div>
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form action="<?=site_url();?>onlinecourse/course/setting" method="post" class="form-horizontal form-label-left">
                            ...
                            <div class="box-footer">
                                <div class="col-md-6 col-sm-6 col-xs-6 col-md-offset-3">                              
                                    <button type="submit" name="setting_btn" value="course" class="btn btn-info pull-left"><?php echo $this->lang->line('save'); ?></button>                                                         
                                </div>                                
                            </div>
