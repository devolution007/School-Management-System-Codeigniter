    ...
    ?>
            ...
            <div class="row">
              ...
              <div class="col-md-8 hide" id="s3_file_div">
               ...
               <div class="col-md-8 hide" id="course_html5_div">
                  <div class="form-group">         

                    <input autofocus="" id="html5" name="html5"  placeholder="" type="file" class="form-control filestyle" accept="video/*" />
                  </div>
              </div>
...
<script>
  ...
  function checkCourseProvider(){
    ...
    if(course_provider == "s3_bucket"){
      ...
      $("#course_html5_div").addClass("hide");
    }
    else if(course_provider == "html5"){
      $("#course_url_div").addClass("hide");
      $("#s3_file_div").addClass("hide");
      $("#course_html5_div").removeClass("hide");
    }
    else{
