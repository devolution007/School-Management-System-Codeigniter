...
<head>
    ...
    <link
        href="<?php echo base_url(); ?>uploads/school_content/admin_small_logo/<?php echo $this->setting_model->getAdminsmalllogo();?>"
    ...
    $function = 'user/user/dashboard';
            ...
            <a href="<?php echo base_url(); ?><?php echo $function; ?>" class="logo">
                ...
                <span class="logo-mini"><img
                        src=" <?php echo $this->customlib->getBaseUrl(); ?>uploads/school_content/admin_small_logo/<?php echo $this->setting_model->getAdminsmalllogo();?>"
                        alt="<?php echo $this->customlib->getAppName() ?>" /></span>

                <span class="logo-lg"><img
                        src="<?php echo $this->customlib->getBaseUrl(); ?>uploads/school_content/admin_logo/<?php echo $this->setting_model->getAdminlogo();?>"
                        alt="<?php echo $this->customlib->getAppName() ?>" /></span>
                ...
                <div class="col-lg-7 col-md-9 col-sm-10 col-xs-8">
                    <div class="pull-right">
                        ...
                        <div class="navbar-custom-menu">
                            ...
                            <div class="currency-icon-list" data-placement="bottom" data-toggle="tooltip"
...
if ($this->studentmodule_lib->hasActive('multi_class')) {
    ?>
                                <li class="cal15"><a href="#" data-placement="bottom" data-toggle="tooltip"
                                        title="<?php echo $this->lang->line('switch_class') ?>"><span
                                            data-toggle="modal" data-target="#classSwitchModal"><i
                                                class="fa fa-exchange" aria-hidden="true"></i></span></a></li>
                                <?php
...
?>
    ...
    ?>
                                <li class="cal15 <?php echo ($is_lock_panel) ? "disable-link" : "" ?>"><a
                                        data-placement="bottom" data-toggle="tooltip"
                                        title="<?php echo $this->lang->line('calendar') ?>"
                                        href="<?php echo base_url() ?>user/calendar/"><i
                                            class="fa fa fa-calendar"></i></a></li>

                                <li data-placement="bottom" data-toggle="tooltip"
                                    title="<?php echo $this->lang->line('task') ?>"
                                    class="dropdown <?php echo ($is_lock_panel) ? "disable-link" : "" ?>">
        ...
        ?>
                                    ...
                                    <ul class="dropdown-menu menuboxshadow">
                                        ...
                                        <li class="todoview plr10 ssnoti">
                                            <?php echo $this->lang->line('today_you_have') . " " . $count . " " . $this->lang->line('pending_task') ?><a
                                                href="<?php echo base_url() ?>user/calendar/" class="pull-right pt0">
                                                <?php echo $this->lang->line('view_all'); ?></a></li>
                                        <li>
                                            <ul class="todolist">
                                                <?php
$tasklist = $this->customlib->getincompleteTask($userdata["id"]);
    ...
    ?>
                                <li class="cal15 <?php echo ($is_lock_panel) ? "disable-link" : "" ?>"><a
                                        ...
                                        href="<?php echo base_url() ?>user/chat"
...
?>
    ...
    ?>
                                        <img src="<?php echo $file . img_time(); ?>" class="topuser-image"
                                            alt="User Image">
                                        <?php
}?>
                                            ...
                                            <div class="sstopuser">
                                                <div class="ssuserleft">
                                                    <a href="<?php echo base_url() ?><?php echo $function; ?>">
                                                        <?php if ($sch_setting->student_photo) {
    ?>
                                                        <img src="<?php echo $file . img_time(); ?>"
                                                            alt="User Image"></a>
                                                    <?php }?>
...
if ($this->module_lib->hasModule('google_authenticator') && $this->module_lib->hasActive('google_authenticator')) {
    ...
    if (is_active_2fa() && $this->auth->addonchk('ssglc', false)) {
        ?>
                                                    ...
                                                    <p class="sspass"><a
                                                            href="<?php echo site_url('user/gauthenticate/setup') ?>"><i
                                                                class="fa fa-cog"></i><?php echo $this->lang->line('setting'); ?></a>
                                                    </p>
...
?>
                                                ...
                                                <div class="sspass">
                                                    <a class="" href="<?php echo base_url(); ?>user/user/changepass"><i
                                                            class="fa fa-key"></i>
                                                        <?php echo $this->lang->line('change_password'); ?></a> <a
                                                        class="pull-right"
    ...
    ?>
            <section class="sidebar <?php echo ($is_lock_panel) ? "disable-sidebar" : "" ?>">
                ...
                <ul class="sidebar-menu verttop38" id="sibe-box">
                    ...
                    <li class="<?php echo set_Topmenu('studentbehaviour'); ?>">
                        <a href="<?php echo base_url(); ?>user/user/studentbehaviour">
                            <i class="fa fa-print"></i> <span> Student Behaviour</span>
                        </a>
                    </li>
                    <li class="<?php echo set_Topmenu('studentResults'); ?>">
                        <a href="<?php echo base_url(); ?>user/user/studentResults">
                            <i class="fa fa-print"></i> <span> <?php if($this->session->userdata('student')['role'] == 'parent'){ echo "Child Result";}else{ echo "Result"; }?></span>
                        </a>
                    </li>
                    <li class="<?php echo set_Topmenu('my_profile'); ?>"><a
                            href="<?php echo base_url(); ?>user/user/profile"><i class="fa fa-user-plus ftlayer"></i>
                    ...
                    <li class="<?php echo set_Topmenu('fees'); ?>"><a
                            href="<?php echo base_url(); ?>user/user/getfees"><i class="fa fa-money ftlayer"></i>
                    ...
                    <li class="<?php echo set_topmenu('user/studentcourse'); ?>"><a
                            href="<?php echo base_url(); ?>user/studentcourse"><i
                                class="fa fa-file-video-o ftlayer"></i>
                            <span><?php echo $this->lang->line('online_course'); ?></span></a></li>
                    <?php }?>
                    ...
                    <li class="<?php echo set_topmenu('Conference'); ?>"><a
                            href="<?php echo base_url('user/conference'); ?>"><i class="fa fa-video-camera ftlayer"></i>
                            <?php echo $this->lang->line('zoom_live_classes'); ?></a></li>
                    <?php }?>
                    ...
                    <li class="<?php echo set_topmenu('Gmeet'); ?>"><a href="<?php echo base_url('user/gmeet'); ?>"><i
                            ...
                            <?php echo $this->lang->line('gmeet') . " " . $this->lang->line('live_class'); ?></a></li>
                    <?php }?>

                    <?php if ($this->studentmodule_lib->hasActive('class_timetable')) {?>
                    <li class="<?php echo set_Topmenu('Time_table'); ?>"><a
                            href="<?php echo base_url(); ?>user/timetable"><i class="fa fa-calendar-plus-o ftlayer"></i>
                    ...
                    <li class="<?php echo set_Topmenu('syllabus'); ?>"><a
                            href="<?php echo base_url(); ?>user/syllabus"><i class="fa fa fa-list-alt ftlayer"></i>
                    ...
                    <li class="<?php echo set_Topmenu('syllabus/status'); ?>"><a
                            href="<?php echo base_url(); ?>user/syllabus/status"><i class="fa fa-list-ol ftlayer"></i>
                            <span><?php echo $this->lang->line('syllabus_status'); ?></span></a></li>
                    <?php }?>
                    ...
                    <li class="<?php echo set_Topmenu('Homework'); ?>"><a
                            href="<?php echo base_url(); ?>user/homework"><i class="fa fa-flask ftlayer"></i>
                    ...
                    <li class="treeview <?php echo set_Topmenu('Onlineexam'); ?>"><a
                            ...
                            <span><?php echo $this->lang->line('online_exam'); ?></span></a></li>
                    <?php }?>

                    <?php if ($this->studentmodule_lib->hasActive('apply_leave')) {?>
                    <li class="<?php echo set_Topmenu('apply_leave'); ?>"><a
                            href="<?php echo base_url(); ?>user/apply_leave"><i class="fa fa-check-square ftlayer"></i>
                            <span><?php echo $this->lang->line('apply_leave'); ?></span></a></li>
                    <?php }?>

                    <?php if ($this->studentmodule_lib->hasActive('visitor_book')) {?>
                    <li class="<?php echo set_Topmenu('visitors'); ?>"><a
                            href="<?php echo base_url(); ?>user/visitors"><i class="fa fa-check-square ftlayer"></i>
                            <span><?php echo $this->lang->line('visitor_book'); ?></span></a></li>
                    <?php }?>
                    ...
                    <li class="treeview <?php echo set_Topmenu('Downloads'); ?>">
                        ...
                        <ul class="treeview-menu">
                            <li class="<?php echo set_Submenu('content/index'); ?>">
                                <a href="<?php echo base_url(); ?>user/content/list"><i
                                        class="fa fa-angle-double-right"></i><?php echo $this->lang->line('contents'); ?></a>
                            </li>

                            <li class="<?php echo set_Submenu('video_tutorial/index'); ?>"><a
                                    href="<?php echo base_url(); ?>user/video_tutorial"><i
                                        class="fa fa-angle-double-right"></i>
                                    <?php echo $this->lang->line('video_tutorial'); ?></a></li>
                        </ul>
                    </li>
                    <?php }?>
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="<?php echo set_Submenu('examresult/index'); ?>"><a
                                    href="<?php echo base_url(); ?>user/exam/examresult"><i
                                        class="fa fa-angle-double-right"></i>
                                    <?php echo $this->lang->line('exam_result'); ?></a></li>
                        </ul>
                    </li>
                    <?php }?>
...
$ntf = $this->customlib->getUserunreadNotification();
        ...
        ?>
                    ...
                    <li class="<?php echo set_Topmenu('Teachers'); ?>"><a
                            ...
                            <span><?php echo $this->lang->line('teachers_reviews'); ?></span></a></li>
                    <?php }?>
                    ...
                    <li class="<?php echo set_Submenu('route/index'); ?>"><a
                            href="<?php echo base_url(); ?>user/route"><i class="fa fa-bus ftlayer"></i>
            ...
            <section class="sidebar">
                <ul class="sidebar-menu " id="sibe-box">
                    <li class="<?php echo set_Topmenu('user/guestprofile'); ?>"><a
                            href="<?php echo base_url(); ?>user/studentcourse/profile"><i
                                class="fa fa-user-plus ftlayer"></i>
                            <span><?php echo $this->lang->line('my_profile'); ?></span></a></li>
                    ...
                    <li class="<?php echo set_topmenu('user/purchasehistory'); ?>"><a
                            href="<?php echo base_url(); ?>user/studentcourse/purchasehistory"><i
                                class="fa fa-file-video-o ftlayer"></i>
                            <span><?php echo $this->lang->line('purchase_history'); ?></span></a></li>
