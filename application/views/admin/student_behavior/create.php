        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <form method="post" action="<?php echo base_url('admin/student_behavior/store'); ?>">
                                ...
                                <div class="form-group">
                                    <label for="email">Ask a Questions</label>
                                    <textarea  class="form-control" id="remarks" name="remarks"></textarea>
                                    <!-- <span class="plus-icon" onclick="addQuestion(this)"><i class="fa fa-plus"></i></span> -->
                                </div>
...
// $(function(){
//     var questionContainer = $('#ask-question-container');
//     var questionTemplate = '';

//     // Append the initial question input
//     questionContainer.append(questionTemplate);

//     // Function to add a new question
//     window.addQuestion = function(element) {
//         var newQuestion = $(questionTemplate);
//         $(element).parent().after(newQuestion);
//     };
// });
